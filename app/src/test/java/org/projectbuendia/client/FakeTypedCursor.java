...
// TODO: This is a duplicate of the version in the instrumentation tests. Move the other tests that
// mock out event bus to the unit tests and then remove this from that target.
