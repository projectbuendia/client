...
public class NameFilterTest {
    ...
    private static Patient getPatientWithName(String givenName, String familyName) {
        return Patient.builder()
            .setGivenName(nameOrUnknown(givenName))
            .setFamilyName(nameOrUnknown(familyName))
            .build();
    }
     ...
     * null.
     */
    private static @Nonnull String nameOrUnknown(@Nullable String name) {
        return Utils.valueOrDefault(name, "–");
    }
