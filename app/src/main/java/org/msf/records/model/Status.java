...
public class Status implements Parcelable, ListItem {
    ...
    static {
        ...
        STATUSES.put("convalescence", new Status("convalescence", R.string.status_convalescence, R.drawable.square_convalescence, R.drawable.round_convalescent, R.color.status_convalescent));
