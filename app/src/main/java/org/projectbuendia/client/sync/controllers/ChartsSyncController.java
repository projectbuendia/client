...
/**
 * Syncs charts from the server to the local database. Note that this is a full sync every time;
 * but seeing as the size of the dataset is small, this shouldn't have a significant performance
 * impact.
 */
public class ChartsSyncController implements SyncController {
