...
public interface MsfCatalog extends Catalog {
    ...
    Category ORAL = new Category("DORA", "oral", DosingType.QUANTITY, PO).withDrugs(
        ...
        new Drug("DORAFLUT", "FLUTICASONE propionate [fr:FLUTICASONE propionate]").withFormats(
            new Format("DORAFLUT5SF", "50 µg / puff, aerosol, 120 doses [fr:50 µg / bouffée, aérosol, 120 doses]", Unit.MG)
        ),
        ...
        new Drug("DORASALM", "SALMETEROL [fr:SALMETEROL]").withFormats(
            new Format("DORASALM2SF", "25 µg / puff, 120 puffs, aerosol [fr:25 µg / bouffée, 120 bouffées, aerosol]", Unit.MG)
        ),
    ...
    Category EXTERNAL = new Category("DEXT", "external", DosingType.QUANTITY).withDrugs(
        ...
        new Drug("DEXOTETR", "TETRACYCLINE hydrochloride [fr:TETRACYCLINE chlorhydrate]").withFormats(
            new Format("DEXOTETR1O5", "1%, eye ointment, ster, 5 g, tube [fr:1%, pommade opht., stér, 5 g, tube]", Unit.ML)
        ),
